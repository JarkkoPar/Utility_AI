...
void UtilityAIDistanceToNode2DSearchCriterion::set_min_distance( float min_distance ) {
...
float UtilityAIDistanceToNode2DSearchCriterion::get_min_distance() const {
    return _min_distance;
}


void UtilityAIDistanceToNode2DSearchCriterion::set_max_distance( float max_distance ) {
...
float UtilityAIDistanceToNode2DSearchCriterion::get_max_distance() const {
...
void UtilityAIDistanceToNode2DSearchCriterion::apply_criterion( Node* node, bool& filter_out, float& score ) {
