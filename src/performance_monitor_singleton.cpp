...
void UtilityAIPerformanceMonitorSingleton::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("increment_total_time_elapsed_ai_agents_update_behaviour_usec", "time_usec"), &UtilityAIPerformanceMonitorSingleton::increment_total_time_elapsed_ai_agents_update_behaviour_usec);
	...
	ClassDB::bind_method(D_METHOD("get_total_time_elapsed_ai_agents_update_behaviour_usec"), &UtilityAIPerformanceMonitorSingleton::get_total_time_elapsed_ai_agents_update_behaviour_usec);
...
int UtilityAIPerformanceMonitorSingleton::get_current_total_time_elapsed_ai_agents_update_behaviour_usec() const {
...
int UtilityAIPerformanceMonitorSingleton::get_total_time_elapsed_ai_agents_update_behaviour_usec() const {
...
void UtilityAIPerformanceMonitorSingleton::increment_total_time_elapsed_ai_agents_update_behaviour_usec(uint64_t time_usec) {
...
void UtilityAIPerformanceMonitorSingleton::initialize_performance_counters() {
	...
	perf->add_custom_monitor("UtilityAI/AI Agent update behaviour time usec", Callable(this, "get_total_time_elapsed_ai_agents_update_behaviour_usec"));
