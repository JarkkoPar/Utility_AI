...
UtilityAIVector3AngleSearchCriterion::UtilityAIVector3AngleSearchCriterion() {
    _min_angle_degrees =   0.0;
...
void UtilityAIVector3AngleSearchCriterion::_bind_methods() {
    
    ClassDB::bind_method(D_METHOD("set_angle_to_direction_vector", "angle_to_direction_vector"), &UtilityAIVector3AngleSearchCriterion::set_angle_to_direction_vector);
    ClassDB::bind_method(D_METHOD("get_angle_to_direction_vector"), &UtilityAIVector3AngleSearchCriterion::get_angle_to_direction_vector);
    ...
    ClassDB::bind_method(D_METHOD("set_min_angle_degrees", "min_angle_degrees"), &UtilityAIVector3AngleSearchCriterion::set_min_angle_degrees);
    ClassDB::bind_method(D_METHOD("get_min_angle_degrees"), &UtilityAIVector3AngleSearchCriterion::get_min_angle_degrees);
    ...
    ClassDB::bind_method(D_METHOD("set_max_angle_degrees", "max_angle_degrees"), &UtilityAIVector3AngleSearchCriterion::set_max_angle_degrees);
    ClassDB::bind_method(D_METHOD("get_max_angle_degrees"), &UtilityAIVector3AngleSearchCriterion::get_max_angle_degrees);
...
void UtilityAIVector3AngleSearchCriterion::_initialize_criterion() {
...
void UtilityAIVector3AngleSearchCriterion::set_angle_to_direction_vector( Vector3 angle_to_direction_vector ) {
    _angle_to_direction_vector = angle_to_direction_vector;
}


Vector3 UtilityAIVector3AngleSearchCriterion::get_angle_to_direction_vector() const {
    return _angle_to_direction_vector;
}


void UtilityAIVector3AngleSearchCriterion::set_min_angle_degrees( double min_angle_degrees ) {
...
double UtilityAIVector3AngleSearchCriterion::get_min_angle_degrees() const {
    return _min_angle_degrees;
}


void UtilityAIVector3AngleSearchCriterion::set_max_angle_degrees( double max_angle_degrees ) {
...
double UtilityAIVector3AngleSearchCriterion::get_max_angle_degrees() const {
...
void UtilityAIVector3AngleSearchCriterion::apply_criterion( Node* node, bool& filter_out, double& score ) {
